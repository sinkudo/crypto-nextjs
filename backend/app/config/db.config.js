var dbProperties = {
    database: 'content', // название базы данных
...
// db.stack = require('../model/stack.model.js')(sequelize, Sequelize);
// db.project_user = require('../model/project_user.model.js')(sequelize, Sequelize);
// db.project_stack = require('../model/project_stack.model.js')(sequelize, Sequelize);
